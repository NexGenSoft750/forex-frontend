...
export function HeroSectionContentText() {
    ...
    return (
        <p className={styles.heroSectionContentText}>
            <span className={`${styles.heroSectionText} ${styles.heroSectionLargeLightText}`}>{t('title')}</span> <span className={styles.heroSectionSmallLightText}>{t('to')}</span>
            <br />
            <span className={`${styles.heroSectionText} ${styles.heroSectionLargeDarkText}`}>{t('brandName')}</span>
            <br />
            <span className={`${styles.heroSectionText} ${styles.heroSectionLargeLightText}`}>{t('gateway')}</span> <span className={styles.heroSectionSmallLightText}>{t('to')}</span>
            <br />

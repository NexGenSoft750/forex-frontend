...
import { FaGoogle, FaFacebookF, FaApple, FaEye, FaEyeSlash, FaTimes } from 'react-icons/fa';
        ...
        <Form>
          ...
          <Form.Group className={styles.formGroup}>
            <Form.Control
              ...
              onChange={(e: ChangeEvent<HTMLInputElement>) => handleInputChange('referralCode', e.target.value)}
